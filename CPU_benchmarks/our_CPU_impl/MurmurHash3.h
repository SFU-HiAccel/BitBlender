...
#ifndef SECTION_LEN_MI
#define SECTION_LEN_MI (32)
#endif
...
#define BV_LENGTH SECTION_LEN_MI*1024*1024*NUM_HASH/bit_vector_width // scalable BF for 1M inserts, 1/2 fp each chunk, 10 chunks
#endif
